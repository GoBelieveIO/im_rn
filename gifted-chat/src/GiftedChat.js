...
class GiftedChat extends React.Component {
    ...
    setMinInputToolbarHeight(minHeight) {
        ...
        var inputHeight = (composerHeight + (minHeight - MIN_COMPOSER_HEIGHT));
        const newMessagesContainerHeight = this.getMaxHeight() - inputHeight - this.getKeyboardHeight() + this.getBottomOffset();
    ...
    getMinInputToolbarHeight() {
        return this.state.minInputToolbarHeight;
    }
